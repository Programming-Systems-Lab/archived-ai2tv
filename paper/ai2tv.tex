...
and adaptation model called ai2tv, a system that allows participants
...
In \cite{EWSPT}, we proposed the idea of using an autonomic controller
...
developed for and used in a variety of domains \cite{AMS,ICSE,ASE}, in
