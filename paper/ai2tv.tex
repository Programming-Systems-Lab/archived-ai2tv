...
% - translate ai2tv -> $\mathrm{AI}^2$TV
%
%
% ---------------------------------------------------------------------------
...
ai2tv, a system that allows geographically dispersed
participants to collaboratively view a video in synchrony.  In
addition, this system uses an autonomic feedback controller that
...
%% This article surveys existing solutions to adaptive video multicast,
%% providing a taxonomy of solutions according to several distinct
%% features. The authors also review the principal techniques from both
%% video coding and network transport perspectives. Finally, they discuss
%% the evaluation methodologies and metrics for adaptive video multicast
%% systems.
...
% -------------------------------
% All the synchronization schemes
% -------------------------------
...
% ----------------------------
% Similar to our video hierarchy
% ----------------------------
