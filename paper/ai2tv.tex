...
level originally selected, and thus missd an average of 63% of the needed frames.
In the latter case, the same clients only missed 35% of the needed frames.
...
%
% PEPPO I would do away with all the rest.
%
%
% ----------------------------
